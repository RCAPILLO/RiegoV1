...
class Grafica(Frame):
    def __init__(self,master,*args):
        ...
        self.line,=ax.plot([],[],color='m',marker='o',linewidth=2,markersize=2,markeredgecolor='m')
    ...
    def iniciar(self):
        self.ani=animacion.FuncAnimation(self.fig,self.animate,interval=100,blit=False)
    ...
    def widgets(self):
        ...
        frame_uno.grid(column=2,row=2,sticky='nsew')
        frame_cuatro=Frame(self.master,bg='black')
        frame_cuatro.grid(column=2,row=0,sticky='nsew')
        ...
        Label(frame_dos,text="Control analogico de prueba",font=("Comic san MS",12,'bold'),bg='black',fg='white').pack(padx=5,expand=1)
        style=ttk.Style()
        ...
        self.combobox_baud.pack(pady=20,expand=1)
        ...
        Label(frame_tres,text='image=self.logo',bg='black').pack(pady=5,expand=1)
    ...
    def cerrar_ventana(self):
        ...
        # Llamamos a la función que muestra la ventana de informes
        if self.mostrar_informes_callback:
