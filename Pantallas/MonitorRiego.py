...
def MonitorRiego():
    ...
    EstadoSistema =Label(miframe,text="Activo",font=("Comica San MS",16)).place(x=440,y=160)
    EstadoSensorA =Label(miframe,text="Bajo",font=("Comica San MS",16)).place(x=440,y=200)
    EstadoSensorB =Label(miframe,text="Ok",font=("Comica San MS",16)).place(x=440,y=240)
    EstadoTemperatura =Label(miframe,text="Alta",font=("Comica San MS",16)).place(x=440,y=280)

    ValorSistema =Label(miframe,text="100%",font=("Comica San MS",16)).place(x=360,y=160)
    ValorSensorA =Label(miframe,text="15%",font=("Comica San MS",16)).place(x=360,y=200)
    ValorSensorB =Label(miframe,text="25%",font=("Comica San MS",16)).place(x=360,y=240)
    ValorTemperatura =Label(miframe,text="24°C",font=("Comica San MS",16)).place(x=360,y=280)
